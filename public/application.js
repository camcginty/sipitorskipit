...
var onGetRecipes = function onGetRecipes(event) {
  ...
  authApi.getRecipes().then(ui.getRecipesSuccess).catch(ui.getRecipesFailure);
};

var recipeUpdate = function recipeUpdate() {
  authApi.getRecipes().then(ui.getRecipesSuccess).catch(ui.getRecipesFailure);
};
...
var onCreateRecipe = function onCreateRecipe(event) {
  ...
  authApi.createRecipe(data).then(ui.createRecipeSuccess).catch(ui.createRecipeFailure).then(sipClickRandomDrink);
};

var onDestroyRecipe = function onDestroyRecipe(event) {
  event.preventDefault();
  var data = $(this).data('id');
  authApi.destroyRecipe(data).then(ui.destroyRecipeSuccess).then(recipeUpdate).catch(ui.destroyRecipeFailure);
};
var onUpdateRecipe = function onUpdateRecipe(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  var id = $(this).data('id');
  authApi.updateRecipe(data, id).then(ui.updateRecipeSuccess).then(recipeUpdate).catch(ui.updateRecipeFail);
};
...
var sipClickRandomDrink = function sipClickRandomDrink() {
  authApi.getDrink().then(ui.getDrinkSuccess).catch(ui.getDrinkFail);
};

var randomDrink = function randomDrink(event) {
  event.preventDefault();
  authApi.getDrink().then(ui.getDrinkSuccess).catch(ui.getDrinkFail);
};
...
var onSignIn = function onSignIn(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  authApi.signIn(data).then(ui.signInSuccess).catch(ui.signInError).then(sipClickRandomDrink);
};
...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://ancient-citadel-83605.herokuapp.com',
...
var store = __webpack_require__(3);
var showDrink = __webpack_require__(13);
var showRecipes = __webpack_require__(30);

var viewToggle = function viewToggle() {
  $('.signed-in-view').toggle();
  $('.signed-out-view').toggle();
};

var getDrinkSuccess = function getDrinkSuccess(getDrinkResponse) {
  var showDrinkHtml = showDrink({ drink: getDrinkResponse.drinks });
  $('.content').html(showDrinkHtml);
};

var getRecipesSuccess = function getRecipesSuccess(getRecipesResponse) {
  ...
  if (getRecipesResponse.recipes.length === 0) {
    ...
    var showRecipesHtml = showRecipes({ recipe: getRecipesResponse.recipes });
    $('.recipes-modal-content').html(showRecipesHtml);
  }
};

var updateRecipeSuccess = function updateRecipeSuccess(updateRecipeResponse) {};
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n <div class=\"display col-sm-12\" data-id=\""
    ...
    + "</h3>\n     </div>\n   </div>\n   <hr>\n\n   <button type=\"button\" class=\"mainCardButtons skipButton\"> <h3 class=\"cardButtonText\">Skip</h3> </button>\n   <form class=\"handlebars-add-form\">\n  <input type=\"hidden\" name=\"recipe[name]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.strDrink : stack1), depth0))
    + "\">\n  <input type=\"hidden\" name=\"recipe[alcoholic]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.strAlcoholic : stack1), depth0))
    + "\">\n  <input type=\"hidden\" name=\"recipe[img]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.strDrinkThumb : stack1), depth0))
    + "\">\n  <input type=\"hidden\" name=\"recipe[glass]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.strGlass : stack1), depth0))
    + "\">\n  <input type=\"hidden\" name=\"recipe[instructions]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.strInstructions : stack1), depth0))
    + "\">\n  <input type=\"hidden\" name=\"recipe[ingredient1]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.strMeasure1 : stack1), depth0))
    + " "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.strIngredient1 : stack1), depth0))
    + "\">\n  <input type=\"hidden\" name=\"recipe[ingredient2]\" value=\""
    ...
    + "\">\n  <input type=\"hidden\" name=\"recipe[ingredient3]\" value=\""
    ...
    + "\">\n  <input type=\"hidden\" name=\"recipe[ingredient4]\" value=\""
    ...
    + "\">\n  <input type=\"hidden\" name=\"recipe[ingredient5]\" value=\""
    ...
    + "\">\n  <input type=\"hidden\" name=\"recipe[ingredient6]\" value=\""
    ...
    + "\">\n  <input type=\"hidden\" name=\"recipe[ingredient7]\" value=\""
    ...
    + "\">\n  <input type=\"hidden\" name=\"recipe[ingredient8]\" value=\""
    ...
    + "\">\n  <input type=\"hidden\" name=\"recipe[ingredient9]\" value=\""
    ...
    + "\">\n  <input type=\"hidden\" name=\"recipe[ingredient10]\" value=\""
    ...
    + "\">\n  <input type=\"hidden\" name=\"recipe[ingredient11]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.strMeasure11 : stack1), depth0))
    + " "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.strIngredient11 : stack1), depth0))
    + "\">\n  <input type=\"hidden\" name=\"recipe[ingredient12]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.strMeasure12 : stack1), depth0))
    + " "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.strIngredient12 : stack1), depth0))
    + "\">\n  <input type=\"hidden\" name=\"recipe[ingredient13]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.strMeasure13 : stack1), depth0))
    + " "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.strIngredient13 : stack1), depth0))
    + "\">\n  <input type=\"hidden\" name=\"recipe[ingredient14]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.strMeasure14 : stack1), depth0))
    + " "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.strIngredient14 : stack1), depth0))
    + "\">\n  <input type=\"hidden\" name=\"recipe[ingredient15]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.strMeasure15 : stack1), depth0))
    + " "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.strIngredient15 : stack1), depth0))
    + "\">\n\n  <button type=\"submit\" class=\"mainCardButtons sipButton\"><h3 class=\"cardButtonText\">Sip</h3></button>\n</form>\n\n   </div>\n</div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.drink : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n  <div class=\"recipe-display col-sm-12\" data-id=\""
    ...
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" name=\"recipe[notes]\" type=\"text\" placeholder=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.notes : stack1), depth0))
    + "\">\n      <div class=\"row\">\n      <button class=\"handlebars-update-button btn-primary handlebars-display handlebars-display-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Add Note</button>\n      <button class=\"handlebars-submit-button btn-primary handlebars-form-hider handlebars-form-hider-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" type=\"submit\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Submit Note</button>\n      <button class=\"delete-button btn-primary\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
